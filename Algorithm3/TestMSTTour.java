///
/// Contents: Test MST tour algorithm
/// Author:   John Aronis
/// Date:     October 2019
///
...
public class TestMSTTour {

  public static int WIDTH=1000, HEIGHT=1000, SEED=12345, WAIT=1000 ;
  ...
  public static ArrayList<City> pseudorandomCities(int n, double maxX, double maxY) {
